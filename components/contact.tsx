    ...
    >
      ...
      <div className="mx-auto w-full max-w-content px-4">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="glow-card relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-2xl shadow-xl shadow-primary/10 p-8 md:p-10 mb-6">
        ...
        >
          <a
            ...
            className="glow-card group flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl px-5 py-4 transition-all duration-200 hover:border-primary/30 hover:bg-primary/5"
          >
          ...
          <div className="glow-card flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl px-5 py-4">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="glow-card group flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl px-6 py-5 transition-all duration-200 hover:border-primary/30 hover:bg-primary/5"
          >
